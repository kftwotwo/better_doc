...
Doctor.prototype.getDoctors = function(specaility) {
  ...
  .then(function(result) {
    result.data.forEach(function(docs){
      $('#test').append("<div class='thumbnail'>"+ "<div class='caption'><h3>" + docs.profile.first_name + "</h3>" + "<p><a href='#' class='btn btn-primary' role='button'>Contact</a>"  + "<img src='docs.profile.image_url'>"  + "</div>");
    });
  })
  .fail(function(error){
